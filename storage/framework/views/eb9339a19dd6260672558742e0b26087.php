...
<?php $__env->startSection('content'); ?>
    ...
    <script src="<?php echo e(url('/assets/plugin/chart.js/Chart.min.js')); ?>" referrerpolicy="no-referrer"></script>
    ...
    <script <?php echo "nonce=\"" . csp_nonce() . "\""; ?>>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const regions = <?php echo json_encode($studentsPerRegion->pluck('region')); ?>;
            const counts = <?php echo json_encode($studentsPerRegion->pluck('total')); ?>;
            ...
            const admittedRegions = <?php echo json_encode($admittedstudentsPerRegion->pluck('region')); ?>;
            const admittedCounts = <?php echo json_encode($admittedstudentsPerRegion->pluck('total')); ?>;
            ...
            new Chart(courseCtx, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($studentsPerCourse->pluck('display_name')); ?>,
                    datasets: [{
                        label: 'Number of Students',
                        data: <?php echo json_encode($studentsPerCourse->pluck('total')); ?>,
            ...
            new Chart(dayCtx, {
                type: 'line',
                data: {
                    labels: <?php echo json_encode($registrationsPerDay->pluck('date')); ?>,
                    datasets: [{
                        label: 'Number of Registrations',
                        data: <?php echo json_encode($registrationsPerDay->pluck('total')); ?>,
                        fill: true,
            ...
            new Chart(ageCtx, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($ageGroups->pluck('age_group')); ?>,
                    datasets: [{
                        label: 'Number of Students',
                        data: <?php echo json_encode($ageGroups->pluck('total')); ?>,
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\episo\Documents\AptitudeTest\themes\dashboard\views/admin/dashboard.blade.php ENDPATH**/ ?>