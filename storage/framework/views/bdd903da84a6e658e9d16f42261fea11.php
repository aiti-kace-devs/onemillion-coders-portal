    ...
    <div class="container">
        ...
        <div class="text-section">
            <div class="logo-container">
                <img src="<?php echo e(url('assets/home/images/c.png')); ?>">
                <img src="<?php echo e(url('assets/images/logo.png')); ?>" alt="One Million Coders Ghana Logo">
            </div>
            <h1>The One Million Coders Program - Ghana</h1>
            <p <?php echo "nonce=\"" . csp_nonce() . "\""; ?> style="font-size: 18px;">Empowering Ghanaian youth with coding skills for the future.</p>
            <p>
            ...
            <a href="<?php echo e(route('application')); ?>">Click to read Application process</a>
            </p>
            <div class="button-container">
                <!-- <a href="https://coders.gikace.org/login" class="btn">Log in</a> -->
                <a href="<?php echo e(route('available-courses')); ?>" class="btn">Register Now</a>
...
<?php /**PATH C:\Users\episo\Documents\AptitudeTest\resources\views/landing-page/index.blade.php ENDPATH**/ ?>