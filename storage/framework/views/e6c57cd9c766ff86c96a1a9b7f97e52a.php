<link rel="stylesheet" href="<?php echo e(url('/assets/plugins/simplemde/simplemde.min.css')); ?>">
<script src="<?php echo e(url('assets/plugins/jquery/jquery.min.js')); ?>"></script>
<script src="<?php echo e(url('/assets/plugins/simplemde/simplemde.min.js')); ?>"></script>


<textarea <?php echo e($attributes); ?> id="template_editor" cols="30" rows="10"><?php echo e($slot); ?></textarea>
...
<?php /**PATH C:\Users\episo\Documents\AptitudeTest\themes\dashboard\views/components/wysiwyg.blade.php ENDPATH**/ ?>