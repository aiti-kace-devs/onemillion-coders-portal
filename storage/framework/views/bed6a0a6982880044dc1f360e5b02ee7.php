...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Modal -->
    <?php echo $__env->make('admin.send-bulk-email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- <?php echo $__env->make('admin.send_bulk_sms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> -->


    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'shortlisted_students','title' => 'Copy and Paste Shortlisted Student Emails','size' => 'modal-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'shortlisted_students','title' => 'Copy and Paste Shortlisted Student Emails','size' => 'modal-lg']); ?>
...
<?php endif; ?>
                    ...
                    <form action="<?php echo e(url('/admin/admit')); ?>" name="admit_form" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select id="session_id" name="session_id" class="form-control"
                                <?php if(empty($sessions)): ?> disabled <?php endif; ?>>
                                <?php if(empty($sessions)): ?>
                                    <option value="">No sessions available</option>
                                <?php else: ?>
                                    <option value="">Choose One Session</option>
                                    <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-course="<?php echo e($session->course_id); ?>" value="<?php echo e($session->id); ?>">
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary"
                                <?php if(empty($sessions)): ?> disabled <?php endif; ?>>Admit</button>
                        </div>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'bulk-sms-modal','title' => 'Send Bulk SMS TESTING','size' => 'modal-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'bulk-sms-modal','title' => 'Send Bulk SMS TESTING','size' => 'modal-lg']); ?>
        ...
        <script <?php echo "nonce=\"" . csp_nonce() . "\""; ?>>
            ...
            $(document).ready(function() {
                ...
                var table = $('#studentsTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('admin.shortlisted_students')); ?>",
                        type: "GET",
                        data: function(d) {
                            d.draw = d.draw;
                            d.start = d.start;
                                ...
                                if (!row.admitted) {
                                    ...
                                    if (row.session_name) {
                                        actionDropdown += '<a class="dropdown-item" href="' +
                                            "<?php echo e(url('student/select-session')); ?>" + '/' + row.userId +
                ...
                $('#admit-selected').click(function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "<?php echo e(route('admin.admit_student')); ?>",
                                type: 'POST',
                                headers: {
                ...
                $(modal).on('modalAction', function(event) {
                    ...
                    var selectedIds = manuallySelectedIds.length > 0 ? manuallySelectedIds : allFilteredIds;
                    $.ajax({
                        url: "<?php echo e(route('admin.send_bulk_email')); ?>",
                        type: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                ...
                $(document).ready(function() {
                    ...
                    modal.on('show.bs.modal', function() {
                        ...
                        $.get("<?php echo e(route('admin.fetch.sms.template')); ?>", function(templates) {
                            templateSelect.empty().append(
                    ...
                    modal.on('modalAction', function(event) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('admin.send_bulk_sms')); ?>",
                            type: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
                ...
                $(document).on('click', '.delete-admission', function(e) {
                    ...
                    const deleteUrl = "<?php echo e(url('admin/delete-student-admission')); ?>/" + userId;
            ...
            $(document).on('click', '#shortlist-modal-submit', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.save_shortlisted_students')); ?>",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                    },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\episo\Documents\AptitudeTest\themes\dashboard\views/admin/manage_shortlist_students.blade.php ENDPATH**/ ?>