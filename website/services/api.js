 ...
 * @param {{ programme_batch_id: number, course_id: number, session_id?: number, course_session_id?: number, capacity_pool?: "reserved"|"standard" }} data
 * @param {string} token
...
/**
 * Backward-compatible helper for in-person enrollment.
 * Uses POST /api/bookings so online and in-person confirmations share one endpoint.
  ...
  return createBooking(
    {
      ...
      course_session_id: data.course_session_id ?? data.session_id,
