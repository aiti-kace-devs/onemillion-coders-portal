...
class UserAdmission extends Model
{
    ...
    protected $fillable = ['user_id', 'programme_batch_id', 'batch_id', 'course_id', 'email_sent', 'session', 'location', 'confirmed'];
    ...
    {
        return $this->belongsTo(CourseBatch::class, 'programme_batch_id');
    }
}
