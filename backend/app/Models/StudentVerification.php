...
class StudentVerification extends Model
{
    ...
    public function getVerifiedByWithDate()
    {
        $adminName = optional($this->admin)->name ?? 'N/A';
        $verificationDate = $this->verification_date ?? 'N/A';

        return $adminName . ' (' . $verificationDate . ')';
    }



    public function getCardTypeUpperCase()
    {
        return strtoupper($this->card_type);
    }


    public function getNameWithPreviousName()
    {
        $previousName = $this->previous_name ?? 'N/A';
