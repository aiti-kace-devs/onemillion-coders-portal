...
class PartnerCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('slug')->type('text')->hint('e.g. coursera, startocode, netacad');
        CRUD::field('active')->type('boolean')->default(true);

        CRUD::addField([
            'name'       => 'api_credentials',
            'label'      => 'API Credentials',
            'type'       => 'textarea',
            'hint'       => 'Enter a valid JSON object. Credentials are stored encrypted.',
            'attributes' => ['rows' => 10, 'style' => 'font-family: monospace; font-size: 13px;'],
        ]);
    }
