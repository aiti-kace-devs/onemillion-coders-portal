...
use App\Config\DynamicFileManagerConfig;
...
return [
     ...
     */
    'configRepository'  => DynamicFileManagerConfig::class,
     ...
     */
    'diskList'          => ['public', 'article_images', 'forum_images', 'article_category_images', 'partner_images', 'product_type_images', 'product_images', 'resources', 'site_settings_images'],
