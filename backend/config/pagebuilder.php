...
return [
    ...
    'use_pagebuilder' => env('USE_PAGEBUILDER', true),

    'show_pagebuilder_pages' => env('SHOW_PAGEBUILDER_PAGES', true),
    ...
    'auth' => [
        'use_login' => true,
        'class' => App\Helpers\PageBuilderAuth::class,
        'url' => '/admin/login',
        'username' => 'admin',
        'password' => env('ADMIN_PASS', 'changethisPASS')
    ],
     ...
     */
    'website_manager' => [
        'use_website_manager' => env('USE_PAGEBUILDER', true),
    ...
    'cache' => [
        'enabled' => true,
        'folder' => storage_path('app/pagebuilder/cache'),
