...
Route::get('/api/otp/check-email', [OtpController::class, 'checkEmail'])->middleware('throttle:otp-secure');
Route::post('/api/otp/send', [OtpController::class, 'send'])->middleware('throttle:otp-secure');
Route::post('/api/otp/verify', [OtpController::class, 'verify'])->middleware('throttle:otp-secure');
Route::get('/api/otp/status', [OtpController::class, 'status'])->middleware('throttle:otp-secure');
