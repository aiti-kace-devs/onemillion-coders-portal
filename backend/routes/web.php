...
Route::get('/api/check-user-recommended-courses-with-available-courses/{userID}', [CourseMatchAPIController::class, 'getUserRecommendedCoursesWithAvailableCourses']);
