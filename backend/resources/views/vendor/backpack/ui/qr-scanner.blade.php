...
@push('after_scripts')
    ...
    <script @nonce>
        ...
        $(function() {
            ...
            $('#startScanner').on('click', function() { startScanner(); });
            $('#stopScanner').on('click', function() { stopScanner(); });
            $('#generateCode').on('click', function() { generateCode(); });
            $('#stopCodeGeneration').on('click', function() { stopCodeGeneration(); });
