...
<x-backpack::menu-item title="Course categories" icon="la la-question" :link="backpack_url('course-category')" />
<x-backpack::menu-item title="Course modules" icon="la la-question" :link="backpack_url('course-module')" />