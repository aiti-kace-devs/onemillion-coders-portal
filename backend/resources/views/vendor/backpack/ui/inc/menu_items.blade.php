...
<x-backpack::menu-item title="Manage Exam Categories" icon="la la-folder" :link="backpack_url('category')" />
...
<x-backpack::menu-dropdown title="Course Moderation" icon="la la-book">
    ...
    <x-backpack::menu-dropdown-item title="Course categories" icon="la la-question" :link="backpack_url('course-category')" />
    <x-backpack::menu-dropdown-item title="Course modules" icon="la la-question" :link="backpack_url('course-module')" />
</x-backpack::menu-dropdown>
