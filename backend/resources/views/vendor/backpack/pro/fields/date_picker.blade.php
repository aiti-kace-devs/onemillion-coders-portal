...
@push('crud_fields_scripts')
    ...
    @if ($field['date_picker_options']['language'] !== 'en')
        <script src="https://cdn.jsdelivr.net/npm/bootstrap-datepicker@1.9.0/dist/locales/bootstrap-datepicker.{{ $field['date_picker_options']['language'] }}.min.js" crossorigin="anonymous"></script>
    @endif
