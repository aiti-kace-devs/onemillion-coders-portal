...
@push('crud_fields_styles')
    ...
    <link href="https://cdn.jsdelivr.net/npm/pc-bootstrap4-datetimepicker@4.17.51/build/css/bootstrap-datetimepicker.min.css" rel="stylesheet" crossorigin="anonymous">
@endpush

{{-- FIELD JS - will be loaded in the after_scripts section --}}
@push('crud_fields_scripts')
    <script src="https://cdn.jsdelivr.net/npm/moment@2.29.4/min/moment.min.js" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/pc-bootstrap4-datetimepicker@4.17.51/build/js/bootstrap-datetimepicker.min.js" crossorigin="anonymous"></script>
    @if ($field['datetime_picker_options']['language'] !== 'en')
        <script src="https://cdn.jsdelivr.net/npm/moment@2.29.4/min/locales.min.js" crossorigin="anonymous"></script>
    @endif
    ...
    <script>
        ...
        // Check if datetimepicker is loaded before extending defaults
        ...
        function bpFieldInitDateTimePickerElement(element) {
            ...
            if (typeof jQuery === 'undefined' || typeof $ === 'undefined') {
                console.error('DateTimePicker: jQuery is not available');
                return;
            }
            
            // Check if datetimepicker plugin is available
            if (!$.fn.datetimepicker) {
                console.error('DateTimePicker: bootstrap-datetimepicker plugin not loaded');
                return;
            }
            ...
            $customConfig = $.extend({
                ...
                // Fallback icons in case defaults weren't set
                icons: {
                    time: 'la la-clock text-bold',
                    date: 'la la-calendar',
                    up: 'la la-arrow-up',
