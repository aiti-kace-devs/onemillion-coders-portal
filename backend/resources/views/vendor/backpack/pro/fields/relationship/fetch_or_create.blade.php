...
@php
    ...
    if($activeInlineCreate) {
        ...
        if(!isset($inlineCreate) || $inlineCreate === false) {
...
@include('crud::fields.inc.wrapper_start')
    ...
    function bpFieldInitFetchOrCreateElement(element) {
        ...
        if($isFieldInline) {
            var modalId = element.closest('.modal').attr('id');
        }

        // Check if element is inside inline-create-dialog modal
        var isInInlineCreateModal = element.closest('#inline-create-dialog').length > 0;
