...
{{-- If a field type is shown multiple times on a form, the CSS and JS will only be loaded once --}}
    ...
    @push('crud_fields_styles')
        {{-- include intl-tel-input css (images load via relative URLs in CSS) --}}
        <link href="https://cdn.jsdelivr.net/npm/intl-tel-input@24.4.0/build/css/intlTelInput.min.css" rel="stylesheet" crossorigin="anonymous">
    ...
    @push('crud_fields_scripts')
        ...
        <script src="https://cdn.jsdelivr.net/npm/intl-tel-input@24.4.0/build/js/intlTelInput.min.js" crossorigin="anonymous"></script>
