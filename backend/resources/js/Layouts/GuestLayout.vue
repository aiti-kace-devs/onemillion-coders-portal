...
onMounted(async () => {
    try {
        const response = await fetch(route("statamic.api.globals.show", "student_login_image"));
...
<template>
    <div :style="backgroundStyle"
        ...
        <div
            class="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-6 px-4 max-w-3xl w-full">
            <img src="/assets/home/images/c.png" alt="Ministry of Communication, Digital Technology and Innovations"
            ...
            <Link href="/" aria-label="One Million Coders home" class="shrink-0">
                <ApplicationLogo src="/assets/images/logo-bt.png" class="h-16 sm:h-20 lg:h-24 w-auto object-contain" />
            </Link>
        </div>
