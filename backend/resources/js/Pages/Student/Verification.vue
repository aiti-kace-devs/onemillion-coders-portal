        ...
        <div class="py-6 space-y-6">
                        ...
                        <div class="bg-gray-50 rounded-xl p-5 border border-gray-100 w-full">
                            ...
                            <ul class="space-y-3">
                                <li class="flex justify-between items-center text-sm border-b border-gray-100 pb-2">
                                    ...
                                    <span class="font-medium text-gray-900" :class="{'text-green-600': latestAttemptStatusLabel === 'Verified', 'text-amber-600': latestAttemptStatusLabel === 'Processed', 'text-red-600': latestAttemptStatusLabel === 'Failed'}">{{ latestAttemptStatusLabel }}</span>
                                </li>
                                <li class="flex justify-between items-center text-sm border-b border-gray-100 pb-2">
                                ...
                                <li class="flex flex-col gap-1 text-sm pt-1">
                                    ...
                                    <span class="font-medium text-gray-800">{{ latestAttemptMessage || "No attempt yet." }}</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-5 border border-gray-100 w-full">
                            ...
                            <ul class="space-y-3">
                                <li class="flex justify-between items-center text-sm border-b border-gray-100 pb-2">
                                    ...
                                    <span class="font-medium px-2 py-0.5 rounded text-xs" :class="isBlocked ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'">{{ isBlocked ? "Yes" : "No" }}</span>
                                </li>
                                <li class="flex justify-between items-center text-sm border-b border-gray-100 pb-2">
                                    <span class="text-gray-500">Name</span>
                                    <span class="font-medium text-gray-800 truncate pl-4">{{ profile.name || "N/A" }}</span>
                                </li>
                                <li class="flex justify-between items-center text-sm border-b border-gray-100 pb-2">
                                    <span class="text-gray-500">Previous Name</span>
                                    <span class="font-medium text-gray-800 truncate pl-4">{{ profile.previous_name || "N/A" }}</span>
                                </li>
            ...
            <div v-if="isVerified" class="bg-white rounded-2xl shadow-sm border border-green-200 overflow-hidden">
                <div class="bg-green-50/50 p-6 border-b border-green-100 flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 shrink-0 shadow-sm border border-green-200">
                ...
                <div class="p-6 md:p-8">
                    <div class="flex flex-col lg:flex-row gap-8 items-start">
                        ...
                        <div class="w-full lg:w-1/3 shrink-0">
                            <div class="rounded-xl overflow-hidden shadow-md border border-gray-200 bg-gray-50 max-w-xs mx-auto lg:mx-0 relative w-full aspect-[3/4]">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div class="bg-gray-50 rounded-lg p-3">
                                        ...
                                        <span class="block text-sm font-semibold text-gray-800">{{ profile.first_name || "N/A" }}</span>
                                    </div>
                                    <div class="bg-gray-50 rounded-lg p-3">
                                        <span class="block text-xs font-medium text-gray-500 mb-1">Last Name</span>
                                        <span class="block text-sm font-semibold text-gray-800">{{ profile.last_name || "N/A" }}</span>
                                    </div>
                                    <div class="bg-gray-50 rounded-lg p-3">
                                        <span class="block text-xs font-medium text-gray-500 mb-1">Middle Name</span>
                                        <span class="block text-sm font-semibold text-gray-800">{{ profile.middle_name || "N/A" }}</span>
                                    </div>
                                    <div class="bg-gray-50 rounded-lg p-3">
                                        <span class="block text-xs font-medium text-gray-500 mb-1">Date of Birth</span>
                                        <span class="block text-sm font-semibold text-gray-800">{{ profile.date_of_birth || "N/A" }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div v-else class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                <div v-if="isBlocked" class="rounded-xl border border-red-200 bg-red-50 p-5 mb-6">
                    <div class="flex items-start gap-3 text-red-800">
                        ...
                        <div>
                            ...
                            <p class="mt-3 text-xs text-red-600/80 font-semibold bg-red-100 inline-block px-2 py-1 rounded">
