    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div v-if="props.user_admission && props.user_admission.confirmed" class="p-6 bg-white shadow sm:rounded-lg">
          <div class="inline-flex space-x-2 items-center text-green-600 font-semibold text-lg">
            <span class="material-symbols-outlined"> check_circle </span>
            <span class="font-semibold">Congratulations, {{ user.name }}! You have been admitted.</span>
          </div>
        </div>
        ...
        <div class="p-6 bg-white sm:rounded-lg shadow">
          ...
          <div class="mt-5 px-5 max-w-2xl">
            <ol class="relative border-l border-green-700">
              ...
              <li class="mb-10 ml-6">
                <span
                  class="absolute flex items-center justify-center w-8 h-8 bg-green-500 rounded-full -left-4 ring-4 ring-white text-white">1</span>
              ...
              <li class="mb-10 ml-6">
                ...
                <div v-if="collapse[1]" class="mt-2 text-sm text-gray-700 pl-2">
                  ...
                  <template v-else>
                    ...
                    <div class="mt-5">
                      <LinkButton :href="`/student/join_exam/${props.user_exam?.exam_id}`">Take test now</LinkButton>
                    </div>
                  </template>
                </div>
              </li>
              ...
              <li class="ml-6">
                ...
                <div v-if="collapse[3]" class="mt-2 text-sm text-gray-700 pl-2">
                  <div v-if="props.user_admission && props.user_admission.confirmed">
                    ...
                    <div class="mt-5">
                      <RevokeOrDeclineAdmissionModal v-if="props.user && props.user_admission" :user="props.user"
                  ...
                  <div>
                    ...
                    <div class="mt-5">
                      <LinkButton v-if="props.user_admission && !props.user_admission.confirmed"
