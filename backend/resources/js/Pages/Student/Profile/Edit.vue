...
const generateIDCard = () => {
    ...
    function drawProfileAndText() {
        ...
        img.onload = () => {
            ...
            ctx.font = "bold 9px Figtree";
            ctx.fillText(
                (props.user.session_dates || "N/A").toUpperCase(),
                valueX,
                detailsY,
            );
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                >
                    <div
                        class="flex flex-col md:flex-row items-center gap-6 relative"
                    >
                        <div
                            class="rounded-full shadow w-24 h-24 overflow-hidden"
                        >
                            <img
                                :src="
                                    user.ghcard_image_url ||
        ...
        >
            ...
            <div class="flex justify-center mt-6">
                <PrimaryButton @click="downloadIDCard" type="button">
                    Download
                </PrimaryButton>
            </div>
        </Modal>
